...
const Faq = () => {
  ...
  const FAQS = [
    ...
    { q: 'Why Razorpay for payments?', a: "We moved to Razorpay - one of India's most trusted payment gateways, used by 10M+ businesses. It supports UPI, cards, net banking, and wallets with bank-grade encryption. Safe, reliable, and battle-tested." },
