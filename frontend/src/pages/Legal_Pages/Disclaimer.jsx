        ...
        <div className="space-y-4 text-sm leading-relaxed text-black/70">
          ...
          <section>
            ...
            <p>
              ...
              relationship between TechJobAlert, its operators, and any user or visitor. We are
          ...
          <section>
            ...
            <p>
              TechJobAlert allows third-party contributors — educators, creators, and professionals —
            ...
            <div className="mt-3 space-y-2">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>You grant TechJobAlert a non-exclusive license to display and distribute the resource on the platform</li>
              </ul>
            </div>
            ...
            <div className="mt-3 space-y-2">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>The exact percentage is agreed upon between TechJobAlert and the contributor prior to listing</li>
                ...
                <li>TechJobAlert is not responsible for delays caused by Topmate's payment infrastructure</li>
              </ul>
            </div>
            ...
            <div className="mt-3 space-y-2">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>TechJobAlert reserves the right to remove, modify, or delist any resource at its sole discretion without prior notice</li>
                <li>Contributors indemnify TechJobAlert against any claims arising from their listed content</li>
              </ul>
            </div>
            ...
            <div className="mt-3 space-y-2">
              ...
              <p>
                If you are interested in listing your resources on TechJobAlert, please reach out to us at
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>TechJobAlert may earn revenue from the sale of digital resources listed on this platform, including those created by third-party contributors</li>
              <li>Where third-party contributor resources are listed, TechJobAlert retains a platform fee from each sale, with the remainder forming the contributor's revenue share</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li><span className="font-medium text-black">Terms &amp; Conditions</span> — sets out the full legal agreement between you and TechJobAlert</li>
