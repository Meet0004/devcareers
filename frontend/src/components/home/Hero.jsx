...
const TRUST_ITEMS = [
  ...
  { icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z", color: "#6b7280", label: "10,000+ Users" },
  { icon: null, label: "Top 0.1% Topmate" },
]
...
const GlassCard = ({ icon, title, description, link, badge, index, visible }) => {
  ...
  return (
    ...
    >
      ...
      <h3 style={{ fontSize: 14, fontWeight: 700, color: '#111', margin: '0 0 6px', letterSpacing: '-0.01em' }}>{title}</h3>
      <p style={{ fontSize: 12, color: '#9ca3af', lineHeight: 1.6, margin: '0 0 16px' }}>{description}</p>
    ...
    <>
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          .hero-cards-grid { grid-template-columns: 1fr !important; gap: 10px !important; }
