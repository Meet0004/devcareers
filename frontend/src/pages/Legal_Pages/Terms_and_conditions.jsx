  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-amber-50">
      ...
      <PageHero
        ...
        subtitle="These terms govern your use of DevCareers. By using our platform, you agree to everything below."
        badges={[
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 flex gap-8">
        ...
        <main className="flex-1 space-y-8 min-w-0">
          ...
          {/* 2. Eligibility */}
          <SectionCard id="eligibility" emoji="🎓" title="Eligibility" borderColor={borderColors[1]}>
          ...
          {/* 3. Services */}
          <SectionCard id="services" emoji="🛠️" title="Our Services" borderColor={borderColors[2]}>
          ...
          {/* 4. Permitted Use */}
          <SectionCard id="permitted-use" emoji="✅" title="Permitted Use" borderColor={borderColors[3]}>
          ...
          {/* 5. Prohibited Use */}
          <SectionCard id="prohibited-use" emoji="🚫" title="Prohibited Use" borderColor={borderColors[4]}>
            <p>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-orange-50 border-2 border-orange-200 rounded-xl p-5">
                ...
                <p className="text-sm text-gray-700 mt-3">
                  To request a refund, email <strong>{import.meta.env.VITE_RECIPIENT_EMAIL}</strong> with your order details
          ...
          {/* 8. Disclaimers */}
          <SectionCard id="disclaimer" emoji="⚠️" title="Disclaimers" borderColor={borderColors[7]}>
          ...
          <SectionCard id="liability" emoji="⚖️" title="Limitation of Liability" borderColor={borderColors[8]}>
            <p>
          ...
          <SectionCard id="third-party" emoji="🔗" title="Third-Party Links & Services" borderColor={borderColors[9]}>
            <p>
          ...
          {/* 11. Termination */}
          <SectionCard id="termination" emoji="🔒" title="Termination" borderColor={borderColors[10]}>
            <p>
          ...
          {/* 12. Changes to Terms */}
          <SectionCard id="changes" emoji="📝" title="Changes to Terms" borderColor={borderColors[11]}>
            <p>
            ...
            <BulletList
              variant="arrow"
              bg="bg-cyan-50 border border-cyan-200 rounded-xl px-4 py-3"
              items={[
          ...
          {/* 13. Governing Law */}
          <SectionCard id="governing-law" emoji="🏛️" title="Governing Law & Disputes" borderColor={borderColors[12]}>
            <p>
            ...
            <p className="text-sm text-gray-600">
              ...
              amicably by contacting Meet Soni at <strong>{import.meta.env.VITE_RECIPIENT_EMAIL}</strong>. If unresolved, disputes
          ...
          {/* 14. Contact */}
          <SectionCard id="contact" emoji="💬" title="Contact Us" borderColor={borderColors[13]}>
            <p>
